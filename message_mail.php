...
try {
    ...
    $mail->Password   = 'bxqo mqdw vssm vjsl'; // App Password
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
    $mail->Port       = 587;

    // Email setup to admin
    $mail->setFrom('info.icbdcc@gmail.com', 'ICBDCC Enquiry');
    $mail->addAddress('info.icbdcc@gmail.com', 'ICBDCC Enquiry');
    ...
    $replyMail->Username   = 'info.icbdcc@gmail.com';
    $replyMail->Password   = 'bxqo mqdw vssm vjsl';
    $replyMail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
    $replyMail->Port       = 587;

    $replyMail->setFrom('info.icbdcc@gmail.com', 'ICBDCC Team');
    $replyMail->addAddress($_POST['email'], $_POST['firstname']);
    $replyMail->isHTML(true);
    $replyMail->Subject = 'Thank you for your enquiry - ICBDCC 2025';
    ...
    $replyMail->Body = '
        <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
            ...
            <p>Warm regards,<br>ICBDCC 2025 Team</p>
        </div>
    ';
